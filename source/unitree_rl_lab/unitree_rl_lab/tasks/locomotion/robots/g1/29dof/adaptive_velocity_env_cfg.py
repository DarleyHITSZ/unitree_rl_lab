...
class RewardsCfg:
    ...
    track_lin_vel_xy = RewTerm(
        func=mdp.track_lin_vel_xy_adaptive,
        weight=1.0,
        params={
    ...
    flat_orientation_l2 = RewTerm(
        func=mdp.flat_orientation_l2_adaptive,
        weight=1.0,
        params={
...
class RobotEnvCfg(ManagerBasedRLEnvCfg):
    """Configuration for the locomotion velocity-tracking environment with adaptive rewards."""
